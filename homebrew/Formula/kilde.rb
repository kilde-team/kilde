class Kilde < Formula
  ...
  url "https://github.com/kilde-team/kilde/releases/download/v0.7.0/kilde-0.7.0-macos.zip"
  # v0.6.0 の実配布物のハッシュ (2026-09-25 のリリースで確定)
  sha256 "e105d07cb88215582d051c5406da41f333af365c106e821987bfff19d65c8d7c"
  license "MIT"
