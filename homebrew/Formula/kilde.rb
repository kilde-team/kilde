class Kilde < Formula
  ...
  url "https://github.com/kilde-team/kilde/releases/download/v0.6.0/kilde-0.6.0-macos.zip"
  # v0.6.0 の実配布物のハッシュ (2026-09-25 のリリースで確定)
  sha256 "0ad4c910dede65bea348c63f47d5a94053a4cb9e52950e8441c26508188ea678"
  license "MIT"
