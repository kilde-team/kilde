class Kilde < Formula
  ...
  url "https://github.com/kilde-team/kilde/releases/download/v0.8.0/kilde-0.8.0-macos.zip"
  # v0.8.0 の実配布物のハッシュ (Release からダウンロードした zip で計算)
  sha256 "3af2c0bd4b4d07830d86a34ac31867c55741855c6173d2e3dce96c24df93595d"
  license "MIT"
